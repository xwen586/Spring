...
public class HelloApp {
	...
	public static void main(String[] args) {
		...
		//使用Spring配置
		ApplicationContext ctx = new ClassPathXmlApplicationContext("xfire/client/appCliContext.xml");
		...
		try {
			...
			String url = "http://localhost:8080/ch084ws/ws/helloService";
			IHelloClient cws = (IHelloClient)factory.create(serviceModel, url);
			String result = cws.sayHello();
